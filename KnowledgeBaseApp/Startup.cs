using KnowledgeBaseApp.Areas.Identity;
...
namespace KnowledgeBaseApp
{
    public class Startup
    {
        ...
        {
            Syncfusion.Licensing.SyncfusionLicenseProvider.RegisterLicense("NTU5MDQ1QDMxMzkyZTM0MmUzMGF6TUsydEdrbDJUeWpSeGJLVm52Yi9LRmVhRWZMMXd6aTVRUmZRdmZlZ1E9");
